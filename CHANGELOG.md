...
- Новый эндпоинт - получить содержимое документа, закодированное Кодом Хаффмана.
  - api/v1/docs/documents/<int:pk>/huffman/

- doc_collections/utils.py утилиты для работы с документами.

- Новый вью DocumentHuffmanView для обработки запроса на получение содержимого документа, закодированного Кодом Хаффмана.
